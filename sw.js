...
class B {
  ...
  async cachePut(e, t) {
    ...
    if (!r)
      return !1;
    const { cacheName: i, matchOptions: c } = this._strategy, o = await self.caches.open(i), h = this.hasCallback("cacheDidUpdate"), g = h ? await j(
...
class V {
  ...
  addToCacheList(e) {
    ...
    for (const s of e) {
      ...
      const { cacheKey: n, url: r } = I(s), i = typeof s != "string" && s.revision ? "reload" : "default";
...
se([{"revision":"65debb53ab32cf0f4912608a7fa6ce4b","url":"index.html"},{"revision":null,"url":"assets/workbox-window.prod.es5-vqzQaGvo.js"},{"revision":null,"url":"assets/index-DBtKJFDZ.css"},{"revision":null,"url":"assets/index-CoTZVB8x.js"},{"revision":"d6be51c1db2ba1a49859a26e5e9c93d7","url":"manifest.webmanifest"}]);
...
self.addEventListener("notificationclick", (a) => {
  ...
  const e = ((t = a.notification.data) == null ? void 0 : t.url) ?? "/nel/";
  a.waitUntil(
    self.clients.matchAll({ type: "window", includeUncontrolled: !0 }).then((s) => {
      for (const n of s)
        if ("focus" in n)
          return n.navigate(e), n.focus();
