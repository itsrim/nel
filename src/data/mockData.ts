...
export interface Event {
  ...
  sectionDateLabel: string; // e.g. "Lundi 23 Mars 2026"
  imageUri: string;
  priceLabel: string;
...
export const MOCK_EVENTS: Event[] = [
  { id: 'e1', title: 'Atelier Cuisine Italienne', location: 'Montmartre, Paris', dateKey: '2026-03-23', timeShort: '08:00', dateLabel: 'Lundi 23 mars', sectionDateLabel: 'Lundi 23 Mars 2026', imageUri: img(101), priceLabel: '57€', participantCount: 22, participantMax: 30, isFavorite: true, isBeta: false, status: 'inscrit', conversationId: 'c1', visitsCount: 120 },
  { id: 'e2', title: 'Visite Musée d\'Orsay', location: 'Café de Flore', dateKey: '2026-03-23', timeShort: '14:00', dateLabel: 'Lundi 23 mars', sectionDateLabel: 'Lundi 23 Mars 2026', imageUri: img(102), priceLabel: '17€', participantCount: 31, participantMax: 150, isFavorite: false, isBeta: false, status: 'inscrit', conversationId: 'c2', visitsCount: 95 },
  { id: 'e3', title: 'Cours de Guitare', location: 'Saint-Germain', dateKey: '2026-03-23', timeShort: '18:00', dateLabel: 'Lundi 23 mars', sectionDateLabel: 'Lundi 23 Mars 2026', imageUri: img(103), priceLabel: 'Gratuit', participantCount: 15, participantMax: 200, isFavorite: false, isBeta: false, status: 'inscrire', conversationId: 'c3', visitsCount: 80 },
  { id: 'e4', title: 'Escape Game', location: 'Station F', dateKey: '2026-03-24', timeShort: '08:00', dateLabel: 'Mardi 24 mars', sectionDateLabel: 'Mardi 24 Mars 2026', imageUri: img(104), priceLabel: '56€', participantCount: 21, participantMax: 20, isFavorite: true, isBeta: false, status: 'inscrit', conversationId: 'c4', visitsCount: 200 },
  { id: 'e5', title: 'Atelier Cocktails', location: 'Le Marais', dateKey: '2026-03-24', timeShort: '19:30', dateLabel: 'Mardi 24 mars', sectionDateLabel: 'Mardi 24 Mars 2026', imageUri: img(105), priceLabel: '21€', participantCount: 7, participantMax: 15, isFavorite: false, isBeta: false, status: 'inscrit', conversationId: 'c5', visitsCount: 60 },
  { id: 'e6', title: 'Cours de Yoga', location: 'Bastille', dateKey: '2026-03-25', timeShort: '11:00', dateLabel: 'Mercredi 25 mars', sectionDateLabel: 'Mercredi 25 Mars 2026', imageUri: img(106), priceLabel: 'Gratuit', participantCount: 6, participantMax: 6, isFavorite: false, isBeta: false, status: 'organisateur', conversationId: 'c6', visitsCount: 150 },
  { id: 'e7', title: 'Concert Jazz', location: 'Opéra Garnier', dateKey: '2026-03-25', timeShort: '20:00', dateLabel: 'Mercredi 25 mars', sectionDateLabel: 'Mercredi 25 Mars 2026', imageUri: img(107), priceLabel: '45€', participantCount: 50, participantMax: 100, isFavorite: true, isBeta: false, status: 'inscrit', conversationId: 'c7', visitsCount: 180 },
  { id: 'e8', title: 'Exposition Art Moderne', location: 'Centre Pompidou', dateKey: '2026-03-26', timeShort: '10:00', dateLabel: 'Jeudi 26 mars', sectionDateLabel: 'Jeudi 26 Mars 2026', imageUri: img(108), priceLabel: '25€', participantCount: 80, participantMax: 150, isFavorite: false, isBeta: false, status: 'inscrire', conversationId: 'c8' },
...
export const MOCK_CONVERSATIONS: Conversation[] = [
  { id: 'c1', title: 'Rando Dimanche', type: 'group', lastMessagePreview: 'Salut ! On se retrouve où ?', avatarGradient: ['#FF6B35', '#FF4081'], unreadCount: 5, updatedAt: Date.now() - 120_000, isFavorite: true },
  { id: 'c2', title: 'Randonneurs', type: 'group', lastMessagePreview: 'Parfait, à demain !', avatarGradient: ['#AB47BC', '#7C4DFF'], unreadCount: 3, updatedAt: Date.now() - 600_000, isFavorite: true },
  { id: 'c3', title: 'Team Paris', type: 'group', lastMessagePreview: 'Le projet avance bien', avatarGradient: ['#26C6DA', '#00BFA5'], unreadCount: 2, updatedAt: Date.now() - 3_600_000, isFavorite: false },
  { id: 'c4', title: 'Soirée Jeudi', type: 'group', lastMessagePreview: 'On se retrouve à 20h', avatarGradient: ['#FFC107', '#FF9800'], unreadCount: 2, updatedAt: Date.now() - 7_200_000, isFavorite: true },
  { id: 'c5', title: 'Clara', type: 'dm', lastMessagePreview: "À tout à l'heure !", avatarGradient: ['#EC407A', '#F48FB1'], unreadCount: 1, updatedAt: Date.now() - 14_400_000, isFavorite: false },
  { id: 'c6', title: 'Yoga Gang', type: 'group', lastMessagePreview: 'Namasté 🧘', avatarGradient: ['#66BB6A', '#43A047'], unreadCount: 0, updatedAt: Date.now() - 86_400_000, isFavorite: false },
  { id: 'c7', title: 'Lucas', type: 'dm', lastMessagePreview: 'Cool, on fait ça !', avatarGradient: ['#42A5F5', '#1E88E5'], unreadCount: 0, updatedAt: Date.now() - 100_000_000, isFavorite: true },
  { id: 'c8', title: 'Amis Proches', type: 'group', lastMessagePreview: 'Merci pour l\'info !', avatarGradient: ['#EF5350', '#E53935'], unreadCount: 0, updatedAt: Date.now() - 200_000_000, isFavorite: false },
];
